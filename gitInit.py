...
if __name__ == '__main__':
    ...
    os.system('curl -u Garretming -d \'{"name":"slg_ui","description":"slg_ui is a ui for slg games"}\' https://api.github.com/user/repos')

    os.system('git remote add origin git@github.com:Garretming/slg_ui.git')
